...
<div class="layoutMainContent">
	...
	{else}
		...
		<p>	</p>
		<h2>個人メニュー</h2>
		<dt><a href="{$URL}pages/patient/appointment.php">個別予防接種予約</a></dt>
		<dd>予防接種の予約・実績を入力するページ</dd>
		<dt><a href="{$URL}pages/patient/patient_calendar.php">予防接種カレンダー</a></dt>
		<dd>誕生日を基準に推奨予防接種時期が過ぎている予防接種のリストを一覧表示する</dd>
		<dt><a href="{$URL}pages/patient/patient_booklist.php">予約一覧表示</a></dt>
		<dd>予約済みの予防接種一覧を表示する</dd>
		<dt><a href="{$URL}pages/patient/patient_history.php">接種履歴詳細</a></dt>
